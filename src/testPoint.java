...
public class testPoint {
	...
	public testPoint(String s) {
		this.line = s;																		//each input row
		this.test = line.split(",");														//split into array of feature
		this.value_test = Arrays.stream(test).mapToDouble(Double::parseDouble).toArray();	//store array as double
